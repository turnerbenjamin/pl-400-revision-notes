...
This section also looks at custom connectors, a Power Apps solution which can
be used to connect Power Apps with external solutions such as Azure functions.
...
skills and poorly written plug-ins can severely impact performance by holding
locks on resources.
...
In the resources, the second option has been used. There is a plug-in base class
but this is a custom, simplified version of that generated by pac plugin init.
